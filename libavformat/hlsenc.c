...
static const AVOption options[] = {
    ...
    {"hls_allow_cache", "explicitly set whether the client MAY (1) or MUST NOT (0) cache media segments", OFFSET(allowcache), AV_OPT_TYPE_INT, {.i64 = -1}, INT_MIN, INT_MAX, E, "hls_allow_cache"},
    {"allow", "The client MAY cache the media segments", 0, AV_OPT_TYPE_CONST, {.i64 = 1}, 0, 0, E, "hls_allow_cache"},
    {"disallow", "The client MUST NOT cache the media segments", 0, AV_OPT_TYPE_CONST, {.i64 = 0}, 0, 0, E, "hls_allow_cache"},
