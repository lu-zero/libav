                                 ...
                                 AVStream *st, MOVStreamContext *sc)
{
    ...
    av_channel_layout_default(&st->codecpar->ch_layout, channel_count);
    ...
    case AV_CODEC_ID_MACE3:
        ...
        sc->bytes_per_frame   = 2 * channel_count;
        break;
    case AV_CODEC_ID_MACE6:
        sc->samples_per_frame = 6;
        sc->bytes_per_frame   = 1 * channel_count;
        break;
    case AV_CODEC_ID_ADPCM_IMA_QT:
        sc->samples_per_frame = 64;
        sc->bytes_per_frame   = 34 * channel_count;
        break;
    ...
    if (bits_per_sample) {
        ...
        sc->sample_size = (bits_per_sample >> 3) * channel_count;
    }
}
